...
export default function Dialog({ onConfirmationClose }) {
    return (
        <>
            <div id="deleteModal" tabIndex="-1" className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center h-[calc(100%-1rem)] w-full md:inset-0 h-modal md:h-full">
                <div className="relative p-4 w-full max-w-md md:h-auto">
                    <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        <button type="button"
                            onClick={() => onConfirmationClose(false)}
                        ...
                        <p className="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete this password?</p>
                        <div className="flex justify-center items-center space-x-4">
                            ...
                            <button type="submit"
                                onClick={() => onConfirmationClose(true)}
