...
export default function Dialog({ onConfirmationClose }) {
    return (
        <>
            <div id="deleteModal" tabIndex="-1" className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-modal md:h-full">
