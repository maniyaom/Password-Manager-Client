...
export default function Navbar({ logout }) {
  return (
    <>
      <div className='w-screen h-16 bg-blue-700 border-0 flex items-center justify-between'>

        <span className='text-2xl font-bold text-white ml-5 mr-2'>Password Manager</span>

        <div className='absolute top-20 left-10 sm:static'>
        ...
        <button type="button"
        onClick={() => logout(true)}
        className="mr-5 ml-4 focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Logout</button>
      </div>
    </>
  )
}
